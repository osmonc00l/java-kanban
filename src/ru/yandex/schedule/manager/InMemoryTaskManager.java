...
public class InMemoryTaskManager implements TaskManager {
    ...
    protected Optional<Task> putInTaskHashMap(Task task) {
    ...
    public boolean updateTask(Task task) {
        if (tasks.containsKey(task.getId())) {
            ...
            Optional<Task> optionalTask = putInTaskHashMap(task);
            if (optionalTask.isEmpty()) {
                putInTaskHashMap(oldTask);
                return false;
            }
            return true;
        } else {
    ...
    protected Optional<Subtask> putInSubtaskHashMap(Subtask subtask) {
    ...
    protected Optional<Epic> putInEpicHashMap(Epic epic) {
        if (epic != null) {
